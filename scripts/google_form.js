...
{
  var getWrangler = {
    "Mozilla Science": ["@stephwright", "s..@mozillafoundation.org", "Steph"],
    "Women & Web Literacy": ["@amirad", "a..@mozillafoundation.org", "Amira"],
    "Mozilla Clubs": ["@jvallera", "j..@mozillafoundation.org", "Julia"],
    "Open Web Fellows": ["@vanessarhinesmith", "v..@mozillafoundation.org", "Vanessa"],
    "Internet of Things": ["@thornet", "m..@mozillafoundation.org", "Michelle"],
    "EU Copyright": ["@melechuga", "m..@mozillafoundation.org", "Melissa"],
    "Hive Austin": ["@omnignorant", "r..@mozillafoundation.org", "Robert"]
  };
  var template_start = "%3C!---%20Keep%20everything%20below%20and%20click%20%27Submit%20new%20issue%27%20%20---%3E%0A%3C!---%20DO%20NOT%20MODIFY%20AFTER%20THIS%20LINE%20---%3E%0A%0A**%5B%20Project%20Contact%20%5D**%20";
  ...
  try
  {
    ...
    var wrangler = getWrangler[community] || (((row%2) == 1) ? ["@zee-moz", "zannah@mozillafoundation.org", "Zannah"] : ["@chadsansing", "chad@mozillafoundation.org", "Chad"]);
